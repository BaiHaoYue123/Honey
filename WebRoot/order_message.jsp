...
<!-- <link rel="stylesheet" type="text/css" href="<%=basePath%>css/main.css"> -->
 <link href="assets/css/style.css" rel="stylesheet" type="text/css" />
  ...
  <div class="h_top">
    <div class="wrap">
      <div class="index.jsp">欢迎进入寻蜜人生！</div>
      <div class="ht_right"> <a href="login">登录</a>|
        <a href="reg">注册</a>
    ...
    <div class="wrap"> <a class="logo" href="/"><img src="images/logo.jpg" width="215" height="50"/></a> 
      ...
      <div class="nav_con">
        <ul class="nav_list">
          ...
          <li class="li4"><a href="index.jsp" class="" >热卖推荐</a></li> 
          <li class="li5"><a href="login.jsp" class="" >个人中心</a></li>
          <li><a href="liuyan.jsp" class="" >给我留言</a></li>
          <li><a href="index.jsp" class="" >关于我们</a></li>
          <div class="cls"></div>
          <div><span style="float:left;margin-top:200px;padding-left:260px;font-size:40px">下单成功！</span></div>
        </ul>
      </div>
    </div>
  </div>
