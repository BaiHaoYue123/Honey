...
/*对图片所在的无序列表li标签对象进行样式设置操作*/      
    .img-li  
    {/*对无序列表标签对象当中样式进行设置操作*/  
        width: 2000%;/*对无序列表标签当中的数据的宽高都设置为100%即和box当中的长宽是相互吻合的*/  
        height:2000%;     
...
/*对图片右边的按钮进行样式的设置*/  
    #next  
    {  
        right: 5px;/*设置next标签对象距离当前盒子的右边距离为0像素*/  
    }  
/*对图片右边的按钮完成样式的设置*/  
...
.button-ul  
        {/*设置ul无序列表标签对象的高度和宽度,以及ul标签对象当中的背景颜色*/  
            ...
            top: 650px;/*设置ul标签对象相对于div标签对象的顶部的距离为240像素*/  
            left: 500px;/*相会于盒子左边的距离为220像素*/  
        }  
/*------------------当前样式设置完毕------------------------------*/  
...
<body>  
    ...
    <div id="box">  
        <ul>  
            ...
            <li class="img-li"><img src="images/111.jpg"></li>  
            <li class="img-li"><img src="images/112.jpg"></li>  
            <li class="img-li"><img src="images/113.jpg"></li>  
            <li class="img-li"><img src="images/114.jpg"></li>  
        </ul>  
        <p>蜂蜜名称：<c:out value="${honey.honeyname}"></c:out></p>
     <p>单价：<c:out value="${honey.unitprice}"></c:out></p>
<!--在当前div当中嵌套两个div来作为图片切换的按钮-->        
         <div id="previous" class="img-button">前一页</div>  
        <div id="next" class="img-button">下一页</div> 
...
<!-- 建立轮播图按钮对象开始 -->  
        <ul class="button-ul"><!-- ul为无序列表标签 -->  
            ...
            <li class="button-li" id="four"></li>  
                                                                                                                                                       ...
                                                                                                                                                       荆条蜜
                                                                                                                                       荆条蜜的蜜源为荆条。荆条是一种耐瘠薄、 耐干旱植物，
                                                                                                                                     流蜜较多。每逢荆条开花季节，每群蜂可产蜜15～20公斤。其
                                                                                                                                     蜜色泽艳，呈半透明琥珀状；结晶细腻乳白，气味芬芳，口感
                                                                                                                                     甜而不腻， 浓度为41度～42度。
                                                                                                                                     并含有10余种矿物质和蛋白质、氨基酸、口感甜润、 微酸， 
                                                                                                                                     多的养分， 所以荆条蜜对于脑力工作者、学生、上班族都非常适合。
                                                                                                                                     荆条蜜能促进体力恢复，也非常适合饭后容易困倦、体力消耗大、精
                                                                                                                                     神压力大者。葡萄糖是肠道益菌的粮食，食用葡萄糖含量较
                                                                                                                                     高的荆条蜜有益于肠道健康。 美容、健体、润燥、祛风解毒、
                                                                                                                                     润肠通便、促进消化助吸收、 开胃健脾、调理肠胃、益气补
                                                                                                                                     中、发汗散热、散寒清目。适合气血不足、伤风头痛、目赤、
                                                                                                                                     失眠者。常服荆条蜜，能增强人体特异性和非特异性免疫功能,
                                                                                                                                     提高体质,对心血管系统疾病,如强心、改善血液循环方面有辅
                                                                                                                                     助疗效,具有排脓托毒、止痛补虚之功效。</pre>
</h3><pre>                                                      
<!-- 建立轮播图按钮对象结束 -->        
</div>  
...
<h2><pre>                                <a href="order_message.jsp">下单</a>          <a href="order_main.jsp">我的订单</a>      <a href="index.jsp">返回主页</a>                                        
</h2></html>  
